...
| meta | 174 | 20 | 0 | 154 |
| game | 830 | 34 | 0 | 796 |
| platform | 2165 | 158 | 113 | 1894 |
| atlas | 1155 | 10 | 0 | 1145 |
| migration_archive | 1 | 1 | 0 | 0 |
| **Total** | **4325** | **223** | **113** | **3989** |
...
The historical correction package, GameAuth, account/character, Marketplace/Payments/Wallet and Marketplace-test audit-evidence defects have all received their recorded independent review waves. The recorder slice is new material: its exact-head post-adoption execution and ledger proof are bound, but author proof is not independent acceptance. A fresh independent exact-head review is therefore still required before that slice can be marked closed.
