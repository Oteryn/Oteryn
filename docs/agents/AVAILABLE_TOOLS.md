...
For technical repository facts, verify the current GitHub and provider-owned source. Notion is a coordination layer and should be kept consistent with verified repository state.

The presence of a tool does not change the task scope. Follow the repository's existing agent instructions and execution contracts while using it.
