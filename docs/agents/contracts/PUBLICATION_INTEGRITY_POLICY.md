...
- repository plus exactly one configured, credential-free approved push target that does not use explicit Git remote-helper `<transport>::<address>` syntax;
