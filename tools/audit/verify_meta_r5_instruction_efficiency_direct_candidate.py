...
LEDGER_SHA='bf51139f97683659f752a54e643c1d342791476d64a0f78237b5c5d3ba3a310a'
...
def validate_adoption(root,c):
 ...
 expected={'candidate_path':CANDIDATE_REL.name,'candidate_sha256':CANDIDATE_SHA256,'adoption_overlay':OVERLAY_REL.name,'adoption_overlay_sha256':OVERLAY_SHA256,'source_commit':SOURCE,'source_tree':SOURCE_TREE,'subtree_tree':SUBTREE_TREE,'live_main_identity_commit':LIVE_MAIN,'path_count':25,'depth':'SCOPED_SEMANTIC_REVIEW','line_ranges':[],'canonical_ledger_sha256':'27654f5f724d9857912e69fd036712dd00d63882ebf8e9c1411c26c66eaeef41','canonical_counts':{'source_rows':4325,'direct_paths':283,'grouped_paths':113,'unverified_paths':3929,'semantically_classified_paths':396},'meta_counts':{'direct_paths':70,'unverified_paths':104,'source_rows':174},'results_row_readopted':False,'meta_aud_05_status':'PARTIALLY_REPAIRED','product_readiness_claimed':False,'audit_completion_claimed':False,'runtime_attested':False}
...
def validate_accounting(root,c,inventory_dir=None):
 ...
 expected={'source_leaves':4361,'scoped_review_paths':309,'grouped_revalidated_paths':113,'unverified_semantics':3939,'semantically_classified_paths':422}
...
def main():
 ...
 print(json.dumps({'result':'META_R5_INSTRUCTION_EFFICIENCY_DIRECT_ADOPTION_VALID_NOT_PRODUCT_PASS','candidate_paths':25,'coverage_delta':25,'coverage_adopted':True,'adoption_performed':True,'current_disposition':'DIRECT','eligible_adoption_depth':'SCOPED_SEMANTIC_REVIEW','source_rows':4361,'direct_paths':309,'grouped_paths':113,'unverified_paths':3939,'semantically_classified_paths':422,'ledger_sha256':LEDGER_SHA,'meta_aud_05_status':'PARTIALLY_REPAIRED','residual_obligations':14,'product_readiness_claimed':False,'audit_completion_claimed':False,'runtime_attested':False,'live_state_claimed':False},sort_keys=True)); return 0
