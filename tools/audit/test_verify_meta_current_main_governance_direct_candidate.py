...
class R7(unittest.TestCase):
 def test_adopted_state(self):
  r=m.validate();self.assertEqual((r['source_leaves'],r['direct'],r['grouped'],r['unverified'],r['semantically_classified']),(4361,335,113,3913,448))
 ...
 def test_historical_packet_separate_adoption_is_visible(self):self.assertEqual(m.validate()['historical_packet_paths_unverified'],0)
