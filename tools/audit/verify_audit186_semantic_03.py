#!/usr/bin/env python3
"""Fail-closed verification for AUDIT186 semantic batch 03."""
...
SELECTED_PATH = "docs/ci/CI_CONTRACT.md"
SELECTED_BLOB = "3c6d36cd58cd81f332382db7f2eda78261788caa"
CANDIDATE = ROOT / "docs/evidence/organization-audit-20260907/audit186-semantic-03-ci-contract-candidate.json"
...
EXPECTED_CANDIDATE_SHA256 = "f47f1e0ae3d71cf287804078af2294722ea4cc2eff1420786878756546c3738a"
PR204_PATHS = {
...
ALLOWED_CHANGED_PATHS = {
    "docs/agents/workers/AUDIT186-SEMANTIC-03.md",
    str(CANDIDATE.relative_to(ROOT)),
    "tools/audit/verify_audit186_semantic_03.py",
    "tools/audit/test_verify_audit186_semantic_03.py",
}
...
def validate_prior_packet_exclusions(path: str = SELECTED_PATH) -> None:
    ...
    if path in PR204_PATHS or path in PR207_PATHS:
...
def validate_repository() -> dict[str, Any]:
    ...
    if git("hash-object", SELECTED_PATH) != SELECTED_BLOB or hashlib.sha256(raw).hexdigest() != "82d3003a2afc3a3fdf0a49a1af3cefc0c542c63dce7d6e2e76f12f05c22b1ffd":
...
def validate() -> dict[str, Any]:
    ...
    return {
        "result": "META_CI_CONTRACT_DIRECT_CANDIDATE_VALID_NOT_ADOPTED",
        "selected_paths": 1,
