...
class PlatformMarketplaceTestsAdoptedTests(unittest.TestCase):
    ...
    def test_summary_accounting_is_current_and_exact(self):
        ...
        self.assertEqual((s['scoped_review_paths'], s['grouped_revalidated_paths'], s['semantically_classified_paths'], s['unverified_semantics_total']), (335, 113, 448, 3913))
    ...
    def test_report_accounting_and_candidate_binding_are_current_and_exact(self):
        r = self.report()
        self.assertEqual(r['revision'], 'R7-META-CURRENT-MAIN-GOVERNANCE-DIRECT-ADOPTED')
        self.assertEqual((r['scoped_review_paths'], r['grouped_revalidated_paths'], r['semantically_classified_paths']), (335, 113, 448))
