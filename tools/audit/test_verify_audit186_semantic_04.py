#!/usr/bin/env python3
"""Adversarial tests for AUDIT186 semantic batch 04."""
...
class Audit186Semantic04Tests(unittest.TestCase):
    ...
    def test_already_grouped_is_rejected(self):
        ...
        def load(path):
            ...
            if path == verifier.GROUPS:
                data["groups"].append({"repository": "meta", "path_prefix": "docs/agents/"})
            return data
    ...
    def test_prior_packet_overlap_is_rejected(self):
        for exclusion in (verifier.PR204_PATHS, verifier.PR207_PATHS, verifier.PR209_PATHS):
