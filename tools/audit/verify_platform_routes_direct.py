...
def validate_current_accounting(audit_root: Path, inventory_dir: Path | None = None) -> None:
    ...
    expected_result = {
        "source_leaves": 4325, "scoped_review_paths": 294,
        "grouped_revalidated_paths": 113, "semantically_classified_paths": 407,
        "unverified_semantics": 3918,
    }
...
def main() -> int:
    ...
    print(json.dumps({"result": "PLATFORM_ROUTES_DIRECT_EXISTING_REVALIDATION_VALID",
                      ...
                      "coverage_delta": 0, "already_canonical_direct": True,
                      "re_adoption_permitted": False, "canonical_direct_paths": 294,
                      "canonical_grouped_paths": 113, "canonical_unverified_paths": 3918,
                      "canonical_semantically_classified_paths": 407,
