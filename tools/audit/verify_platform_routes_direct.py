...
ORIGINAL_REVIEW_SHA256 = "37a224e512d7055ae869e11d230051bef2514458c2b019665953bd40b974b7fe"
...
def validate_current_accounting(audit_root: Path, inventory_dir: Path | None = None) -> None:
    ...
    require(ledger_bytes.count(b"\n") - 1 == 4361, "recomputed canonical ledger row count drift")
    require(sum(grouped_counts.values()) == 113, "recomputed canonical GROUPED count drift")
    expected_result = {
        "source_leaves": 4361, "scoped_review_paths": 309,
        "grouped_revalidated_paths": 113, "semantically_classified_paths": 422,
        "unverified_semantics": 3939,
    }
...
def main() -> int:
    ...
    print(json.dumps({"result": "PLATFORM_ROUTES_DIRECT_EXISTING_REVALIDATION_VALID",
                      ...
                      "coverage_delta": 0, "already_canonical_direct": True,
                      "re_adoption_permitted": False, "canonical_direct_paths": 309,
                      "canonical_grouped_paths": 113, "canonical_unverified_paths": 3939,
                      "canonical_semantically_classified_paths": 422,
