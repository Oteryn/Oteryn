...
CANONICAL_LEDGER_SHA = '27654f5f724d9857912e69fd036712dd00d63882ebf8e9c1411c26c66eaeef41'
...
def validate_adopted_docs(candidate: dict, audit_root: Path) -> None:
    ...
    require(report.get('revision')=='R3-NATIVE-EVIDENCE-POST-REVIEW-PLATFORM-SEMANTIC-CARRYFORWARD-113-DIRECT-283','report revision drift')
    ...
    require(report.get('scoped_review_paths')==283 and report.get('grouped_revalidated_paths')==113 and report.get('semantically_classified_paths')==396,'report accounting drift')
    ...
    require(summary.get('scoped_review_paths')==283 and summary.get('grouped_revalidated_paths')==113 and summary.get('unverified_semantics_total')==3929 and summary.get('semantically_classified_paths')==396,'summary accounting drift')
    ...
    require(len(review)==283,'canonical DIRECT count drift')
