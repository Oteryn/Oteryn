...
CANONICAL_LEDGER_SHA = 'd93838bebb6f3690bad3d6182bbc05edd0af8acf8a98d28260e496276b95a22b'
...
def validate_adopted_docs(candidate: dict, audit_root: Path) -> None:
    ...
    require(report.get('revision')=='R7-META-CURRENT-MAIN-GOVERNANCE-DIRECT-ADOPTED','report revision drift')
    ...
    require(report.get('scoped_review_paths')==335 and report.get('grouped_revalidated_paths')==113 and report.get('semantically_classified_paths')==448,'report accounting drift')
    ...
    require(summary.get('scoped_review_paths')==335 and summary.get('grouped_revalidated_paths')==113 and summary.get('unverified_semantics_total')==3913 and summary.get('semantically_classified_paths')==448,'summary accounting drift')
    ...
    require(len(review)==335,'canonical DIRECT count drift')
