...
def validate_accounting(audit_root: Path) -> None:
    ...
    require((summary.get('grouped_revalidated_paths'), summary.get('semantically_classified_paths'), summary.get('unverified_semantics_total')) == (113, 422, 3939), 'Marketplace-test summary totals drift')
    ...
    require((report.get('scoped_review_paths'), report.get('grouped_revalidated_paths'), report.get('semantically_classified_paths')) == (309, 113, 422), 'Marketplace-test report accounting drift')
