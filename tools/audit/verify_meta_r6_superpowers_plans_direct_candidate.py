#!/usr/bin/env python3
"""Fail-closed verifier for the META R6 historical plans DIRECT candidate."""
...
CANDIDATE_REL = Path('docs/evidence/organization-audit-20260907/r3-meta-r6-superpowers-plans-direct-candidate.json')
CANDIDATE_SHA256 = 'a1b90554559a94602250782ac4d490038b4186d43653e19d69b69bc01c7791be'
...
SUBTREE = 'docs/superpowers/plans'
SUBTREE_TREE = '5753610ef6c6f4c15ce198d620b072022eb18971'
...
def validate_source(root, candidate):
    ...
    require(actual_paths == expected_paths and len(set(expected_paths)) == 9, 'exact ordered family path set drift')
...
def validate_accounting(root, candidate, inventory_dir=None):
    ...
    require(len(selected) == 9 and {row['path'] for row in selected} == set(wanted), 'candidate ledger path set drift')
